...
<div class="form-group">
{!!Form::label('Nick:')!!}
{!!Form::text('name', null,['class'=>'form-control', 'placeholder'=>'Ingrese su nick', 'readonly' ])!!}

</div>
<div class="form-group">
{!!Form::label('Correo:')!!} 
{!!Form::text('email', null,['class'=>'form-control', 'placeholder'=>'Ingrese Correo Electronico', 'readonly'])!!}
